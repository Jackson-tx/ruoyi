    ...
    <el-row :gutter="10">
      <el-col :span="8">
        <el-card style="height: calc(100vh - 125px)">
          <div slot="header">
            <span><i class="el-icon-collection"></i> 接口访问列表</span>
            <el-button
...
<script>
import { listVisitCount,clearCacheName } from "@/api/monitor/count";
...
export default {
  ...
  methods: {
    ...
    handleClearCacheName(row) {
      clearCacheName(row.cacheKey).then(response => {
